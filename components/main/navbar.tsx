    ...
    <div className="w-full h-[65px] fixed top-0 shadow-lg shadow-[#2A0E61]/50 bg-[#03001427] backdrop-blur-md z-50 px-4 sm:px-6 lg:px-10">
      ...
      <div className="w-full h-full flex items-center justify-between m-auto px-0 sm:px-[10px]">
        ...
        >
          ...
          /> */}
          <div className="flex font-bold text-gray-300 text-sm sm:text-base whitespace-nowrap">
            Mohammad Zaid
          </div>
        </Link>
        ...
        {/* Hamburger Menu */}
        <button
          className="md:hidden text-white focus:outline-none text-3xl leading-none"
